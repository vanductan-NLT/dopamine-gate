...
${JSON.stringify(t,null,2)}`}]}],generationConfig:{temperature:.1,topP:.8,maxOutputTokens:256}})});if(!l.ok){let S=await l.json().catch(()=>({}));return console.error("Gemini API error:",S),l.status===400?{decision:"block",confidence:1,message:"API key kh\xF4ng h\u1EE3p l\u1EC7. Vui l\xF2ng ki\u1EC3m tra l\u1EA1i trong Settings."}:{decision:"block",confidence:1,message:"L\u1ED7i k\u1EBFt n\u1ED1i v\u1EDBi AI. M\u1EB7c \u0111\u1ECBnh ch\u1EB7n \u0111\u1EC3 b\u1EA3o v\u1EC7 b\u1EA1n."}}let v=(p=(u=(o=(a=(n=(await l.json()).candidates)==null?void 0:n[0])==null?void 0:a.content)==null?void 0:o.parts)==null?void 0:u[0])==null?void 0:p.text;if(!v)throw new Error("Empty response from Gemini");let f=v.match(/\{[\s\S]*\}/);if(!f)throw new Error("No JSON found in response");let r=JSON.parse(f[0]);if(!r.decision||!["allow","block"].includes(r.decision))throw new Error("Invalid decision format");return{decision:r.decision,confidence:r.confidence??.5,message:r.message??"Quy\u1EBFt \u0111\u1ECBnh d\u1EF1a tr\xEAn AI",classification:r.classification}}catch(l){return console.error("Gemini evaluation error:",l),{decision:"block",confidence:.5,message:"Kh\xF4ng th\u1EC3 x\u1EED l\xFD ph\u1EA3n h\u1ED3i AI. M\u1EB7c \u0111\u1ECBnh ch\u1EB7n \u0111\u1EC3 b\u1EA3o v\u1EC7 b\u1EA1n."}}}function E(e){return e.futureFeeling==="Waste"?{decision:"block",confidence:1,message:"Ch\xEDnh b\u1EA1n c\u0169ng th\u1EA5y l\u01B0\u1EDBt ti\u1EBFp l\xE0 ph\xED th\u1EDDi gian. H\xE3y d\u1EEBng l\u1EA1i th\xF4i! \u{1F6D1}"}:e.outcome==="Emptiness"?{decision:"block",confidence:.9,message:"\u0110\u1EEBng \u0111\u1EC3 b\u1EA3n th\xE2n r\u01A1i v\xE0o c\u1EA3m gi\xE1c tr\u1ED1ng r\u1ED7ng sau khi l\u01B0\u1EDBt. \u0110i l\xE0m g\xEC \u0111\xF3 c\xF3 \xEDch h\u01A1n \u0111i! \u2728"}:null}var d=20;var s=1,m=6;function P(){let e=document.createElement("link");e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200",document.head.appendChild(e)}function A(){return document.getElementById("dopamine-gate-overlay")!==null}function I(){return window.location.hostname}async function T(){if(!window.dg_initializing){window.dg_initializing=!0;try{if(A()){console.log("[Dopamine Gate] Overlay already exists, skipping");return}P(),await c()?M():R(),window.dg_observer_active||(_(),window.dg_observer_active=!0)}finally{window.dg_initializing=!1}}}function _(){new MutationObserver(i=>{if(!A()){console.log("[Dopamine Gate] Blocker was removed by site. Re-injecting..."),T();return}document.body.style.overflow!=="hidden"&&(document.body.style.overflow="hidden")}).observe(document.documentElement,{childList:!0,subtree:!0})}function M(){let e=document.createElement("div");e.id="dopamine-gate-overlay",e.className="dopamine-gate-overlay",e.innerHTML=`
  ...
  `)}function k(e){var o;let i=document.getElementById("dopamine-gate-form");if(!i)return;let t=e.decision==="block",n=t?"Access Blocked":"Access Allowed",a=t?"blocked":"allowed";i.innerHTML=`
    <div class="dopamine-gate-result ${a}">
      <div class="dopamine-gate-result-icon">
  ...
  `,t?H():(o=document.getElementById("dg-btn-proceed"))==null||o.addEventListener("click",()=>{q()})}function H(){let e=5,i=document.getElementById("dg-countdown"),t=setInterval(()=>{e--,i&&(i.textContent=e.toString()),e<=0&&(clearInterval(t),chrome.runtime.sendMessage({type:"CLOSE_TAB"}))},1e3)}function q(){let e=document.getElementById("dopamine-gate-overlay");e==null||e.remove(),document.body.style.overflow=""}T();})();
